...
// floor texure
const floorAlphaTexure = textureLoader.load("./floor/alpha.webp");
...
const floor = new THREE.Mesh(
  new THREE.PlaneGeometry(floorData.width, floorData.height, 100, 100),
  new THREE.MeshStandardMaterial({
    alphaMap: floorAlphaTexure,
    transparent: true,
...
const door = new THREE.Mesh(
  new THREE.PlaneGeometry(doorData.width, doorData.height, 100, 100),
  new THREE.MeshStandardMaterial({
